...
- Derived `Debug` for all public types: `WaapiClient`, `WaapiClientSync`, `SubscriptionHandle`, `SubscriptionHandleSync`

## [0.2.1] - 2026-03-28

### Fixed

- Fixed `GOODBYE` message type code: was `3` (ABORT), corrected to `6` per the WAMP spec
